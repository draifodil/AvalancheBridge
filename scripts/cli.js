...
const contractABI = require("../artifacts/contracts/Avalanchebridge.sol/Avalanchebridge.json").abi;

program
    .name("avalanchebridge-cli")
    .description("CLI tool for Avalanchebridge smart contract")
    .version("1.0.0");
