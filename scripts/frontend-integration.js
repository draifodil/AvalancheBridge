 ...
 * This file demonstrates how to integrate Avalanchebridge with a web frontend
 */

// For React/Vue/Angular applications
export class AvalanchebridgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AvalanchebridgeClient(provider, contractAddress);
